...
public class Main {
	...
	public static void main(String[] args) {
		...
		employee1.getLaptop().add(laptop1);
		employee2.getLaptop().add(laptop2);
		employee3.getLaptop().add(laptop3);
		employee1.getLaptop().add(laptop4);
		employee2.getLaptop().add(laptop5);
